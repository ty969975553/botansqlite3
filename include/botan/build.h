...
* 'configure.py --cc=msvc --msvc-runtime=MT --disable-shared-library --cpu=x86_32 --cc-bin=C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\cl.exe'
*
* Target
*  - Compiler: C:\Program Files (x86)\Microsoft Visual Studio 14.0\VC\bin\cl.exe /MT /bigobj /EHs /GR /D_ENABLE_EXTENDED_ALIGNED_STORAGE /O2 /Oi
*  - Arch: x86_32
*  - OS: windows
*/
...
#define BOTAN_INSTALL_LIB_DIR "c:\Botan\lib"
