...
#ifdef _DEBUG 
#define ENCRYPT_SQLITE_TRACE(msg) fprintf(stderr, "TRACE: %s\n", msg)
#else
#define ENCRYPT_SQLITE_TRACE(msg)
#endif
...
{
    ENCRYPT_SQLITE_TRACE("PagerFreeCodec");
...
{
    ENCRYPT_SQLITE_TRACE("CodecSizeChange");
    (void)nReserve;
    assert(pageSize >= 0);
...
{
    ENCRYPT_SQLITE_TRACE("sqlite3_activate_see");
    (void)info;
}

int sqlite3CodecAttach(sqlite3 *db, int nDb, const void *zKey, int nKey)
{
    ENCRYPT_SQLITE_TRACE("sqlite3CodecAttach");
    void *pCodec = NULL;
...
{
    ENCRYPT_SQLITE_TRACE("sqlite3CodecGetKey");
...
{
    ENCRYPT_SQLITE_TRACE("sqlite3_key_v2");
...
{
    ENCRYPT_SQLITE_TRACE("sqlite3_rekey_v2");
...
{
    ENCRYPT_SQLITE_TRACE("sqlite3_key");
...
{
    ENCRYPT_SQLITE_TRACE("sqlite3_rekey");
